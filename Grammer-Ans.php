<?php
session_start();
include('./Assets/_Partial Components/Grammer.php');
            ...
            <div class="col-md-6" id = "answer-form">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        $Subject_link = "Grammer?id=".urlencode(base64_encode($ecrypt_1));?>
                        <a href="<?=$Subject_link;?>">
        ...
        <div class="col-sm-9" style = "display: none;">
            <form class="form-horizontal" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="Subject" value = "Grammer" style="color: black;"  placeholder="3rd Answer">
                </div>
              </div>
              <div class="form-group">
