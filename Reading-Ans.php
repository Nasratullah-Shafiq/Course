<?php
session_start();
include('./Assets/_Partial Components/Reading.php');
        ...
        <table class="table" >
                <thead>
                    <tr>  
                        ...
                        <th> <?php echo "<img alt=''width='150px' height = '120px' src='./Assets/img/_Profile_Picture/$profile_img' style = 'margin-top: -5px; margin-bottom: -5px;' />"; ?> </th>
                    </tr>
                    <tr>
            ...
            <div class="col-md-6" id = "answer-form">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        $Subject_link = "Reading?id=".urlencode(base64_encode($ecrypt_1));?>
                        <a href="<?=$Subject_link;?>">
        ...
        <div class="col-sm-9" style = "display: none;">
            <form class="form-horizontal" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="Subject" value = "Reading" style="color: black;"  placeholder="3rd Answer">
                </div>
              </div>
              <div class="form-group">
