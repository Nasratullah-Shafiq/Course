...
<div class="container container-index">
	...
	<?php if (isset($_GET['id'])) {
 	...
 	foreach ($_GET as $key => $data) {
		...
		$Research_ID = ((($data2*999999)/9999)/123456789);?>
			...
			<?php 
			 ...
			 if($Research->num_rows>0){
				...
				<div id = "btnAdike" class="col-md-12 img-details" style="padding-left: 0px; padding-right: 0px;">
					<?php echo "<img width = '100%' height = '300px' alt='' src='./Assets/img/Research/$news_img '/>"; ?>
				</div>
...
<?php 	}
    ...
    <div class="col-md-8 news-bod">
			...
			<?php 
				...
				$Research = $mtd->getLatestResearch();
