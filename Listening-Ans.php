<?php
session_start();
include('./Assets/_Partial Components/Listening.php');
        ...
        <table class="table" >
                <thead>
                    <tr>  
                        ...
                        <th> <?php echo "<img class = 'img-circle' alt=''width='150px' height = '120px' src='./Assets/img/_Profile_Picture/$profile_img' style = 'margin-top: -5px; margin-bottom: -5px;' />"; ?> </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th> Your Name </th>
                        <th> <?php echo $_SESSION['Change_Username']; ?> </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <div class="col-md-6" id = "answer-form">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="Reading?id=<?php echo $Subject_ID = $_GET['id'];?>">
        ...
        <div class="col-sm-9" style = "display: none;">
            <form class="form-horizontal" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="Subject" value = "Listening" style="color: black;"  placeholder="3rd Answer">
                </div>
              </div>
              <div class="form-group">
