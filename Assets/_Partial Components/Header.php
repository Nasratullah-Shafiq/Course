...
<head>
  ...
  <!--   <meta http-equiv="X-UA-Compatible" content="IE=edge"> -->
    ...
    <link href = "./Assets/CSS/owl-carousel-style.css" rel="stylesheet" type = "text/css">
...
<nav class="navbar navbar-inverse navbar-static-top" style = "background-color: rgb(0,33,71); margin-bottom: 0px; border-color: rgb(0,33,71);">
      <div class="container">
        <div class="navbar-header">
          ...
          <div class = "col-xs-9" id = "div-quiz" style="padding-top: 5px;"><img src="Assets/img/Logo/CELC.png" alt="Logo" width="100px">
          </div> 
          </a>
