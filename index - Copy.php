                    ...
                    <div id="carousel1" class="owl-carousel">
                       <div class="item">
                           <div class="card text-center">
                                <img class="card-img-top" style = "border-radius: 5px;" src="Assets/img/Book/startup.jpg" alt="Generic placeholder image" width="140" height="360">                                    
                                <div class="card-body">
                                    <h3>START-UP </h3>
                       ...
                       <div class="item">
                           <div class="card text-center">
                                <img class="img-circle" style = "border-radius: 5px;" src="Assets/img/Book/openup.jpg" alt="Generic placeholder image" width="140" height="360">                                    
                                <div class="card-body">
                                    <h3>OPEN-UP </h3>
                                </div>
                           </div>
                       ...
                       <div class="item">
                           <div class="card text-center">
                                <img class="img-circle" style = "border-radius: 5px;" src="Assets/img/Book/warmup.jpg" alt="Generic placeholder image" width="140" height="360">                                    
                                <div class="card-body">
                                    <h3>WARM-UP </h3>
                                </div>
                           </div>
                       ...
                       <div class="item">
                           <div class="card text-center">
                                <img class="img-circle" style = "border-radius: 5px;" src="Assets/img/Book/runup.jpg" alt="Generic placeholder image" width="140" height="360">                                    
                                <div class="card-body">
                                    <h3>RUN-UP </h3>
                                </div>
                           </div>
                       ...
                       <div class="item">
                           <div class="card text-center">
                                <img class="img-circle" style = "border-radius: 5px;" src="Assets/img/Book/roundone.jpg" alt="Generic placeholder image" width="140" height="360">                                    
                                <div class="card-body">
                                    <h3> ROUND ONE </h3>
                                </div>
                           </div>
                       ...
                       <div class="item">
                           <div class="card text-center">
                                <img class="img-circle" style = "border-radius: 5px;" src="Assets/img/Book/roundtwo.jpg" alt="Generic placeholder image" width="140" height="360">                                    
                                <div class="card-body">
                                    <h3>ROUND TWO </h3>
                                </div>
                           </div>
                       ...
                       <div class="item">
                           <div class="card text-center">
                                <img class="img-circle" style = "border-radius: 5px;" src="Assets/img/Book/roundsix.jpg" alt="Generic placeholder image" width="140" height="360">                                    
                                <div class="card-body">
                                    <h3> ROUND SIX </h3>
                                </div>
                           </div>
                       ...
                       <div class="item">
                           <div class="card text-center">
                                <img class="card-img-top" style = "border-radius: 5px;" src="Assets/img/Book/poineer.jpg" alt="Generic placeholder image" width="140" height="360">                                    
                                <div class="card-body">
                                    <h3> POINEER </h3>
                                </div>
                           </div>
                       ...
                       <div class="item">
                           <div class="card text-center">
                                <img class="card-img-top" style = "border-radius: 5px;" src="Assets/img/Book/poineerplus.jpg" alt="Generic placeholder image" width="140" height="360">                                    
                                <div class="card-body">
                                    <h3> POINEER PLUS</h3>
                                </div>
                           </div>
